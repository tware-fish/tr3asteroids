...
function onloadHandler()
{
   ...
   g_backgroundImg.src = 'images/coralreef_bg..jpg';
...
Asteroids.Colours =
{
   ...
   GREEN_LASER: "yellow",
   GREEN_LASER_DARK: "rgb(255, 238, 0)",
   GREEN_LASERX2: "rgb(255, 0, 144)",
   GREEN_LASERX2_DARK: "#85ff85",
   PLAYER_BOMB: "rgb(155,255,155)",
   PLAYER_THRUST: "lightgreen",
...
(function()
{
   Asteroids.Main = function()
   {
      ...
      loader.addImage(g_playerImg, 'images/realplayerslug.png');
      loader.addImage(g_asteroidImgs[0], 'images/sponge1comp.png');
      loader.addImage(g_asteroidImgs[1], 'images/sponge2comp.png');
      loader.addImage(g_asteroidImgs[2], 'images/sponge3comp.png');
      loader.addImage(g_asteroidImgs[3], 'images/sponge4comp.png');
   ...
   extend(Asteroids.AttractorScene, Game.Scene,
   {
      ...
      onRenderScene: function onRenderScene(ctx)
      {
         ...
         else
         {
            ...
            t(ctx, Game.Util.message("please-wait"), "18pt Arial", GameHandler.height*0.5, "lightgreen");
         }
      },
      ...
      sineText: function sineText(ctx, txt, xpos, ypos)
      {
         ...
         for (var i=0, j=txt.length; i<j; i++)
         {
            ...
            f(ctx, txt[i], "36pt Courier New", x + i*30, y, "lightgreen");
         }
         this.sine += 0.075;
      },
...
(function()
{
   ...
   extend(Asteroids.GameOverScene, Game.Scene,
   {
      ...
      intervalRenderer: function intervalRenderer(interval, ctx)
      {
         ...
         {
            Game.fillText(ctx, interval.label, "18pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5 - 32, "yellow");
            Game.fillText(ctx, Game.Util.message("score") + ": " + this.game.score, "14pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5, "lightgreen");
            if (this.game.score === this.game.highscore)
            {
               Game.fillText(ctx, Game.Util.message("new-high-score") + "!", "14pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5 + 24, "lightgreen");
            }
         }
         else
         {
...
(function()
{
   ...
   extend(Asteroids.GameCompleted, Game.Scene,
   {
      ...
      intervalRenderer: function intervalRenderer(interval, ctx)
      {
         ...
         {
            Game.fillText(ctx, interval.label, "18pt Courier New", GameHandler.width*0.5 - 96, GameHandler.height*0.5 - 32, "yellow");
            Game.fillText(ctx, Game.Util.message("score") + ": " + this.game.score, "14pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5, "lightgreen");
            if (this.game.score === this.game.highscore)
            {
               Game.fillText(ctx, Game.Util.message("new-high-score") + "!", "14pt Courier New", GameHandler.width*0.5 - 64, GameHandler.height*0.5 + 24, "lightgreen");
...
(function()
{
   ...
   extend(Asteroids.GameScene, Game.Scene,
   {
      ...
      intervalRenderer: function intervalRenderer(interval, ctx)
      {
         ...
         {
            var f = (BITMAPS ? Game.fillText : Game.drawText);
            f(ctx, interval.label, "18pt Courier New", GameHandler.width*0.5 - 48, GameHandler.height*0.5 - 8, "lightgreen");
         }
         else
         {
            interval.complete = true;
      ...
      renderOverlay: function renderOverlay(ctx)
      {
         ...
         Game.fillText(ctx, sscore, "12pt Courier New", 120, 12, "lightblue");
         ...
         Game.fillText(ctx, Game.Util.message("hi-score") + ": " + sscore, "12pt Courier New", 220, 12, "lightgreen");
